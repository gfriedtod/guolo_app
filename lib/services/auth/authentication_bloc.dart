  ...
  AuthenticationBloc(this.dio) : super(const AuthenticationState.initial()) {
    on<AuthenticationEvent>((event, emit) async {
        ...
        try {
          ...
          if (response.statusCode == 200) {
            ...
            try {
              ...
              prefs.setString('user',  JsonEncoder().convert(response.data['user']));
              print(response.data);
      ...
      sendOtp: (_SendOtp value) async {
        ...
        try {
          print(value.email);
          Response result = await dio.post(ApiRoute.sendOtp(),data: new SendOtpRequest(email: value.email).toJson());
          if (result.statusCode == 200) {
